...
public class ReviewServiceImpl implements ReviewService {
    ...
    public boolean updateReview(Long reviewId, Review updatedReview) {
        ...
        if(review != null)
        {
            ...
            reviewRepository.save(review); // next time let's say when we call Company 1's review-2, then we will get this updatedReview object[with the new Description; new title etc.].....not the old review object which had id 2 and old descriptions.
            return true;
        }
        else return false;
    }
